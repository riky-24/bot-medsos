...
export const MESSAGES = {
  ...
  HELP:
    `👩‍💼 **PUSAT BANTUAN ANGGUN**\n` +
    `━━━━━━━━━━━━━━━━━━━━\n` +
    `Halo Kak! Saya **Anggun**, siap membantu kebutuhan top-up Kakak hari ini.\n\n` +
    `**Panduan Singkat:**\n` +
    ...
    `Ada kendala? Klik tombol **Admin** di bawah ya Kak.`,
  ...
  RATE_LIMIT:
    `☕ **Santai Sejenak, Kak...**\n` +
    `Permintaan Kakak terlalu cepat. Tunggu beberapa detik ya agar sistem tetap stabil. ⏳`,

  RATE_LIMIT_TOAST: "Sabar ya Kak, tunggu sebentar... ⏳",

  // Payment Flow
  PAYMENT_PROCESSING:
    `⏳ **MENGHUBUNGI GATEWAY...**\n` +
    `━━━━━━━━━━━━━━━━━━━━\n` +
    `Mohon tunggu sebentar, Anggun sedang menyiapkan detail pembayaran Kakak.`,

  PAYMENT_ERROR:
    `❌ **METODE TIDAK TERSEDIA**\n` +
    `Maaf Kak, metode pembayaran ini sedang dalam pemeliharaan. Silakan gunakan metode lain ya. 🙏`,

  ORDER_CANCELLED:
    `✅ **PESANAN DIBATALKAN**\n` +
    `━━━━━━━━━━━━━━━━━━━━\n` +
    `Sesi pemesanan telah ditutup dengan aman. Terima kasih sudah mencoba layanan kami.\n\n` +
    `Jangan ragu untuk memesan kembali kapan saja Kak! Kami siap melayani 24/7. 😊`,
  ...
  GAME_NOT_FOUND:
    ...
    `Maaf Kak, game yang Kakak cari belum tersedia di daftar kami saat ini. 😢`,
  ...
  TOPUP_VOUCHER_TITLE: `🎟️ **VOUCHER & DIGITAL WALLET**`,
  ...
  ADMIN_CONTACT:
    `Kakak bisa hubungi admin kami di: @admin_b7store (Jam kerja 09.00 - 21.00 WIB) 👨‍💻`,
